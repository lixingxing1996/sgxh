<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:33:"./themes/admin/weixin/index2.html";i:1504360477;s:24:"./themes/admin/base.html";i:1504353925;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            ...
            <li ><a href="<?php echo url('admin/weixin/index1'); ?>">已经办卡用户</a></li>
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <form class="layui-form layui-form-pane" action="<?php echo url('admin/weixin/index2'); ?>" method="get">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo $vo['open']==1 ? '开通' : '未开通'; ?></td>
                        <td>
