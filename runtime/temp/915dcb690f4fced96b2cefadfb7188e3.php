<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:33:"./themes/admin/weixin/index3.html";i:1504360477;s:24:"./themes/admin/base.html";i:1504353925;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <form class="layui-form layui-form-pane" action="<?php echo url('admin/weixin/index3'); ?>" method="get">
