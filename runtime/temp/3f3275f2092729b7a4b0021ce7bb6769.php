<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:32:"./themes/admin/weixin/index.html";i:1504360476;s:24:"./themes/admin/base.html";i:1504353925;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <form class="layui-form layui-form-pane" action="<?php echo url('admin/weixin/index'); ?>" method="get">
                    <div class="layui-inline">
                        <label class="layui-form-label">关键词</label>
                        <div class="layui-input-inline">
                            <input type="text" name="keyword" value="<?php echo $keyword; ?>" placeholder="请输入关键字" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo $vo['sdopen']==1 ? '开通' : '未开通'; ?></td>
                        <td><?php echo $vo['open']==1 ? '开通' : '未开通'; ?></td>
                        <td><?php echo mb_substr($vo['remark'], 0, 10, 'utf-8' )  ?></td>
                        <td>
