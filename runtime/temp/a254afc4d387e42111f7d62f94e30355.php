<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:33:"./themes/admin/data/download.html";i:1504360460;s:24:"./themes/admin/base.html";i:1504353925;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class="layui-this">下载文件</li>
        </ul>
        <div class="layui-tab-content">
               <a href="<?php echo $link; ?>" class="layui-btn layui-btn-big layui-btn-primary layui-btn-radius">点我下载</a>            
        </div>
    </div>
</div>
